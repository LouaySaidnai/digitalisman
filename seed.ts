  ...
  await prisma.produit.createMany({
    data: [
      ...
      },
      {
        ...
        prix: "Gratuit",
        slug: "1-heure-de-ping-pong-sans-les-mains",
        dateModification: new Date(),
      },
      {
      ...
      },
      {
        ...
        prix: "1 990 €",
        slug: "premiers-clients-la-preuve-par-3-3-3",
        dateModification: new Date(),
      },
      {
      ...
      },
      {
        ...
        livrable: "À définir",
        prix: "495-€",
        slug: "devenir-mentor-en-afrique",
        dateModification: new Date(),
      },
      {
